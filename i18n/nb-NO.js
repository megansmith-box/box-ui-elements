export default {
  ...
  "boxui.unifiedShare.contactRestrictionNotice": "Invitasjoner kan ikke sendes til {count, plural, one {{email}} other {{count} personer}} fordi det eksterne samarbeidet er begrenset på grunn av den anvendte klassifiseringen.",
  ...
  "boxui.unifiedShare.justifiableContactRestrictionNotice": "Dette klassifiserte innholdet krever en forretningsbegrunnelse for å invitere {count, plural, one {{email}} other {{count} personer}}. Velg en forretningsbegrunnelse nedenfor.",
